...
const PagerDot = ({ active = false, idx, dotClickHandler, gaCategory, label }) => {
  ...
  return (
    <button onClick={() => {onClickHandler(idx)}} className={className} key={idx} name={label} aria-label={label}>
